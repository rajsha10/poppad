...
contract Poppad {
    ...
    function create(
        ...
        require(msg.value >= fee, "Poppad: Creator fee not met");
    ...
    function buy(address _token, uint256 _amount) external payable {
        ...
        require(sale.isOpen == true, "Poppad: Buying closed");
        require(_amount >= 1 ether, "Poppad: Amount too low");
        require(_amount <= 10000 ether, "Poppad: Amount exceeded");
        ...
        require(msg.value >= price, "Poppad: Insufficient ETH received");
    ...
    function deposit(address _token) external {
        ...
        require(sale.isOpen == false, "Poppad: Target not reached");
        ...
        require(success, "Pop-Pad: Transfer failed");
    }

    function withdraw(uint256 _amount) external {
        require(msg.sender == owner, "Poppad: Not owner");
